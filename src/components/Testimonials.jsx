        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {testimonials.map((t, i) => (
            ...
            >
              ...
              <p className="text-accent-600 leading-relaxed flex-1 mb-6">{t.text}</p>
              <div className="flex items-center gap-3 pt-4 border-t border-accent-100">
                ...
                />
                <div>
                  <p className="font-semibold text-accent-900 text-sm">{t.name}</p>
                  <p className="text-accent-400 text-xs">{t.org}</p>
                </div>
              </div>
            </motion.div>
          ))}
