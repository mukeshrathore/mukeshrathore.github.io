...
export default function Portfolio() {
  return (
    <section id="portfolio" className="py-24 lg:py-32 bg-accent-50">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project, i) => (
            <motion.a
              ...
              className={`group relative overflow-hidden rounded-2xl shadow-sm border border-accent-100 ${project.span}`}
            >
              ...
              <div className="p-4 bg-white md:hidden">
                <h3 className="font-display font-semibold text-accent-900">{project.title}</h3>
              </div>
            </motion.a>
          ))}
        </div>
